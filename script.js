...
╚═╝     ╚═╝╚═╝  ╚═╝╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝`;
    ...
    const welcome =
      ...
      this.wrapWithColor(
        "         AI & ML Engineer • Deep Learning • Full-Stack\n",
        "#666666"
      ) +
      this.wrapWithColor(divider + "\n\n", "#555555") +
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Passionate AI & Machine Learning Engineer currently",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "pursuing B.Tech in AI & ML at Parul University.",
      "#ffffff"
    )}
${this.wrapWithColor(
  "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor(
  "   Building end-to-end intelligent systems sit at the",
  "#ffffff"
)}
${this.wrapWithColor("   crossroads of AI and real-world software.", "#ff8c00")}

${this.wrapWithColor("⚡ Expertise", "#ff8c00")}
${this.wrapWithColor(
  "   Deep Learning pipelines, production-ready REST APIs,",
  "#ffffff"
)}
${this.wrapWithColor(
...
${this.wrapWithColor("⚡ Academic", "#ff8c00")}
${this.wrapWithColor(
  "   Actively researching CNN architectures and multi-tenant",
  "#ffffff"
)}
${this.wrapWithColor("   ERP platform orchestration.", "#ffffff")}
...
<span style="color: #00ffff;">COGNIFYZ TECHNOLOGIES | Machine Learning Intern</span>
${this.wrapWithColor("Jun 2024 - Aug 2024 | Remote, India", "#ffffff")}
${this.wrapWithColor(
  "Production ML workflow delivering classification models",
  "#98fb98"
)}

• ${this.wrapWithColor("Data Preprocessing", "#ffa07a")} - ${this.wrapWithColor(
      "Built end-to-end pipelines using Python/Pandas.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Model Rigor", "#ffa07a")} - ${this.wrapWithColor(
      "Applied cross-validation and hyperparameter tuning.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Visualization", "#ffa07a")} - ${this.wrapWithColor(
      "Developed dashboards with Matplotlib.",
      "#ffffff"
    )}
...
<span style="color: #00ffff;">DELOITTE AUSTRALIA | Data Analytics Intern</span>
${this.wrapWithColor("May 2024 - Jun 2024 | Virtual Internship", "#ffffff")}

• ${this.wrapWithColor("Customer Insights", "#ffa07a")} - ${this.wrapWithColor(
      "Performed data cleaning and statistical analysis.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Enterprise Workflows", "#ffa07a")} - ${this.wrapWithColor(
      "Mastered predictive modeling and data visualization.",
      "#ffffff"
    )}

<span style="color: #00ffff;">TATA GROUP | Business Analytics Intern</span>
${this.wrapWithColor("Apr 2024 - May 2024 | Virtual Internship", "#ffffff")}

• ${this.wrapWithColor("AI Analytics", "#ffa07a")} - ${this.wrapWithColor(
      "Applied GenAI tooling to optimize data reporting.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Reporting", "#ffa07a")} - ${this.wrapWithColor(
      "Structured workflows for preprocessing and evaluation.",
      "#ffffff"
    )}`;
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
      " Engineering intelligent systems with measurable impact ",
      "#ffffff"
    )}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
  "╰──────────────────────────────────────────────────╯",
...
<span style="color: #00ffff;">Machine & Deep Learning:</span>
• ${this.wrapWithColor("TensorFlow / CNN / Computer Vision", "#ffffff")}
• ${this.wrapWithColor("Scikit-Learn / Model Evaluation", "#ffffff")}
• ${this.wrapWithColor("Supervised Learning (Classification/Regression)", "#ffffff")}

<span style="color: #00ffff;">Web Development (MERN):</span>
• ${this.wrapWithColor("MongoDB / Express.js / React.js / Node.js", "#ffffff")}
• ${this.wrapWithColor("Tailwind CSS / REST APIs", "#ffffff")}

<span style="color: #00ffff;">Programming & Core CS:</span>
• ${this.wrapWithColor("Python / Java / SQL / JavaScript", "#ffffff")}
• ${this.wrapWithColor("DSA / OOP / OS Fundamentals / DBMS", "#ffffff")}

<span style="color: #00ffff;">Tools:</span>
• ${this.wrapWithColor("Git / GitHub / VS Code / Jupyter / Postman", "#ffffff")}`;
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:madhansenthilkumar1@gmail.com" style="color: #ffffff; text-decoration: none;">madhansenthilkumar1@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://madhan-portfolio-ruby.vercel.app" target="_blank" style="color: #ffffff; text-decoration: none;">madhan-portfolio.vercel.app</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/AppleYT9" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/AppleYT9</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://linkedin.com/in/madhan-senthilkumar" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/madhan-senthilkumar</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
    ...
    this.projects = [
      {
        ...
        image: "image/project-erp.png",
        technologies: ["React", "TypeScript", "Spring Boot", "MySQL"],
        demo: "https://github.com/AppleYT9",
        repo: "https://github.com/AppleYT9",
      },
      {
        title: "CNN Flood Detection",
        description:
          "Satellite image classification system for automated flood impact detection.",
        image: "image/project-flood.png",
        technologies: ["TensorFlow", "Python", "CNN"],
        demo: "https://github.com/madhansenthilkumar",
        repo: "https://github.com/madhansenthilkumar",
      },
    ];
  }
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "madhan@portfolio: ~/interactive-resume";
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝`;
    ...
    role.textContent = "AI & ML Engineer • Deep Learning • Full-Stack";
    ...
    url.textContent = "madhan-portfolio.vercel.app";
